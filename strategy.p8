...
function _init()
	init_units()
	place_unit(1,2,slime)
	u=place_unit(3,1,anya)
...
function make_unit(name,k,class,tal,aff,lvl,brain)
	st={
		name=name,
		k=k,
		res={0,0,0},
...
function init_units()
	...
	goblin=make_unit("goblin",17,"fighter","sword",1,-3,default_brain)
	goblin.enemy=true
	slime=make_unit("slime",21,"fighter","squish",1,-3,default_brain)
	slime.enemy=true
end
...
function get_stat(unit,keyword)
	return flr(unit.stats[keyword] * unit.modifiers[keyword])
end
...
function deal_dmg(trgt,atkr,dmg,typ)
	...
	if(typ==2 and trgt.stats.typ==3) dmg *= 0.75
	if(typ==3 and trgt.stats.typ==1) dmg *= 0.75
	dmg=round(max(0,dmg))
...
function update_nav()
	act_un.nav=navgrid(act_un.x,act_un.y,slds,get_stat(act_un,"spd"),act_un.stats.brain,act_un.enemy)
end
...
function b_menu(s)
	...
	elseif(s==3) then -- attack menu
		make_menu(2,77,64,32,nil,format_spells(act_un.stats.spells),nil,atk_slct)
...
function atk_slct(s)
	atkdata=atks[act_un.stats.spells[s]]
...

...

...
__gff__

...

